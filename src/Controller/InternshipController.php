...
class InternshipController extends AbstractController
{
    ...
    public function index(InternshipRepository $internshipRepository, ExportParameterRepository $parameter): Response
    {
        return $this->render('internship/index.html.twig', [
            'internships' => $internshipRepository->findAll(),
            'exportParameters' => json_decode($parameter->findOneBy(['dtype' => 'internship'])->getField(), true),
        ]);
    }
