...
class TrainerCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('role', new TranslatableMessage('admin.pages.trainers.columns.role', domain: $this->getTranslationDomain())),
            IntegerField::new('entrance_code', new TranslatableMessage('admin.pages.trainers.columns.entrance_code', domain: $this->getTranslationDomain())),
            DateTimeField::new('entrance_code_date', new TranslatableMessage('admin.pages.trainers.columns.entrance_code_date', domain: $this->getTranslationDomain())),
            ...
            TextField::new('signature', new TranslatableMessage('admin.pages.users.columns.signature', domain: $this->getTranslationDomain()))
                ...
                ->setRequired(false),
            AssociationField::new('coordinator', new TranslatableMessage('admin.pages.trainers.columns.coordinator', domain: $this->getTranslationDomain()))->setQueryBuilder(
                fn(QueryBuilder $queryBuilder) => $queryBuilder->getEntityManager()->getRepository(Coordinator::class)->findAll()
            )
        ];
    }
}
